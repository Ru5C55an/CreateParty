...
fileprivate class ConfettiType {
    let color: UIColor
...
fileprivate enum ConfettiShape {
    case rectangle
    case circle
}

fileprivate enum ConfettiPosition {
    case foreground
    case background
}

class ConfettiEffect: UIView {
    ...
    fileprivate var confettiTypes: [ConfettiType] = {
        let confettiColors = [
